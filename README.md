...
Назрела необходимость иметь не только глобальное состояние приложения, но и локальные хранилища для динамически загружаемых страниц - повозившись с react-redux можно это реализовать, но наша реализация проще.
...
| Param          | Type          | Description                                                                             | Optional / Required |
| -------------- | ------------- | --------------------------------------------------------------------------------------- | ------------------- |
| selector       | React.Context | функция селектор, для выборки данных из состояния                                       | Optional            |
| actionCreators | React.Context | Объект из функций генераторов событий или функция, создающая объект генераторов событий | Optional            |
| ownProps       | React.Context | свойства, пробрасываемые контейнеру                                                     | Optional            |
