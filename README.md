...
Размер подключаемого кода около 3кб минифицированного и [1.5кб](https://bundlephobia.com/result?p=@budarin/use-react-redux) в сжатом виде и она полностью консистентна в Concurent Mode и даже более производительна чем react-redux ! :)
